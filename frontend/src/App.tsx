...
function App() {
  ...
  return (
    <div className="flex justify-center items-center w-full min-h-screen h-full border border-solid border-black  p-10 flex-col gap-2">
      <h1 className="text-4xl h-full font-bold text-gray-700">| BROADCASTING CHAT APP |</h1>
